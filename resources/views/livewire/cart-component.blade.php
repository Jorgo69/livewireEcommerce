                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" data-title="Stock">
                                                    <div class="detail-qty border radius  m-auto">
                                                        <a href="#" class="qty-down" wire:click.prevent="incrementQuantity('{{$Item->rowId}}')"><i class="fi-rs-angle-small-down"></i></a>
                                                        <span class="qty-val">{{$Item->qty}}</span>
                                                        <a href="#" class="qty-up" wire:click.prevent="decrementQuantity('{{$Item->rowId}}')"><i class="fi-rs-angle-small-up"></i></a>
                                                    </div>
                                                </td>
                                                <td class="text-right" data-title="Cart">
                                                    <span>${{$Item->subtotal}} </span>
                                                </td>
                                                <td class="action" data-title="Remove"><a href="#" class="text-muted" wire:click.prevent="delete('{{$Item->rowId}}')"><i class="fi-rs-trash"></i></a></td>
                                            </tr>
                                        @endforeach

                                    <tr>
                                        <td colspan="6" class="text-end">
                                            <a href="#" class="text-muted" wire:click.prevent="destroy()"> <i class="fi-rs-cross-small"></i> Clear Cart</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="text-center">
                                <strong> Aucun Produit dans le Panier </strong>
                            </div>
                            @endif
                        </div>
                                ...
                                <div class="border p-md-4 p-30 border-radius cart-totals">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td class="cart_total_label">Panier Sous total</td>
