                        ...
                        <div class="row align-items-center slider-animated-1">
                            <div class="col-lg-5 col-md-6">
                                <div class="hero-slider-content-2">
                                    ...
                                    <a class="animated btn btn-brush btn-brush-2" href="{{$slide ->link}}"> Achetez maintenant </a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                                    <img class="animated slider-1-2" src="{{ asset('assets/imgs/slider')}}/{{$slide->image}}" alt="{{$slide ->title}}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single-hero-slider single-animation-wrap">
                    <div class="container">
                        <div class="row align-items-center slider-animated-1">
                            <div class="col-lg-5 col-md-6">
                                <div class="hero-slider-content-2">
                                    <h4 class="animated">Offre de reprise</h4>
                                    <h2 class="animated fw-900">Supper value deals</h2>
                                    <h1 class="animated fw-900 text-brand">Sur tout les produits</h1>
                                    <p class="animated">Economisez plus avec des coupons allant jusqu'a 70% de reduction</p>
                                    <a class="animated btn btn-brush btn-brush-3" href="product-details.html"> Magasinez Maintenant </a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                ...
                <div class="tab-header">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{$tri == 'featered' ? 'active' : 'false'}}" id="nav-tab-one" data-bs-toggle="tab" data-bs-target="#tab-one" type="button" role="tab" aria-controls="tab-one" aria-selected="{{$tri == 'featered' ? 'true' : 'false'}}" wire:click.prevent="changement('featered')">Featured</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="nav-tab-two" data-bs-toggle="tab" data-bs-target="#tab-two" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Popular</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{$tri == 'new_added' ? 'active' : 'false'}}" id="nav-tab-three" data-bs-toggle="tab" data-bs-target="#tab-three" type="button" role="tab" aria-controls="tab-three" aria-selected="{{$tri == 'new_added' ? 'true' : 'false'}}" wire:click.prevent="changement('new_added')">New added</button>
                        </li>
                    </ul>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">                                
                                    ...
                                    <div class="product-img-action-wrap">
                                        ...
                                        <div class="product-badges product-badges-position product-badges-mrg">
                                            <span class="{{$tri == 'new_added' ? 'new' : 'hot'}}">{{$tri == 'new_added' ? 'NEW' : 'HOT'}}</span>
                                        </div>
                                    </div>
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="shop.html">Vêtement</a>
                                        </div>
                                        <h2><a href="product-details.html">{{ substr($product->short_description, 0, 20)}} ...</a></h2>
            ...
            <div class="container wow fadeIn animated">
                ...
                <div class="carausel-6-columns-cover position-relative">
                    ...
                    <div class="carausel-6-columns" id="carausel-6-columns">
                        @forelse ($popular_produit as $populaire)
                            <div class="card-1">
                                <figure class=" img-hover-scale overflow-hidden">
                                    <a href="@auth {{  Auth::user()->utype === 'ADM' ? route('admin.category.edit', ['category_id' => $populaire->id]) : route('product.category', ['slug' => $populaire->slug]) }}@endauth"><img src="{{asset('assets/imgs/categories')}}/{{$populaire->image}}" alt="" width="164" height="164"></a>
                                    {{-- <a href="{{ route('admin.category.edit', ['category_id' => $populaire->id])}}"><img src="{{asset('assets/imgs/categories')}}/{{$populaire->image}}" alt="" width="164" height="164"></a> --}}
                                </figure>
                                <h5><a href="shop.html">{{$populaire->name}}</a></h5>
                            </div>
                        @empty
            ...
            <div class="container wow fadeIn animated">
                ...
                <div class="carausel-6-columns-cover position-relative">
                    ...
                    <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                        @forelse ($last_produit as $new_produit)
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="product-details.html">
                                        <img class="default-img" src="{{asset('assets/imgs/products')}}/{{$new_produit->image}}" alt="">
                                        {{-- <img class="hover-img" src="assets/imgs/shop/product-2-2.jpg" alt=""> --}}
                                    </a>
                                </div>
                                <div class="product-action-1">
                            ...
                            <div class="product-content-wrap">
                                <h2><a href="product-details.html">{{$new_produit->name}}</a></h2>
                                <div class="rating-result" title="90%">
                                    <span>
                                    </span>
                                </div>
                                <div class="product-price">
                                    <span>${{$new_produit->regular_price }}</span>
                                    {{-- <span class="old-price">$245.8</span> --}}
                                </div>
                            </div>
                        </div>
